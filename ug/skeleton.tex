...
Effect handler-oriented programming is a programming paradigm that allows for the creation of composable code. Effects are 


Effects handlers represent a programming paradigm that is uniquely composable. an extension of the common programming tool of catching exceptions. When an exception is caught by the program, the control flow is terminated  interrupts control flow to 
